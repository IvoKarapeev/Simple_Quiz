...
const QuizFour = () => {
    ...
    return(
        <div className={styles.background}>
            ...
            <button className={styles['btn-one']} onClick={wrongAnswer}>100</button>
            <button className={styles['btn-two']} onClick={() => correctAnswer(4)}>1000</button>
            <button className={styles['btn-three']} onClick={wrongAnswer}>1</button>
            <button className={styles['btn-four']} onClick={wrongAnswer}>675</button>
        </div>
    )
};
